...
Kirigami.FormLayout {
    ...
    property alias cfg_connectionName: connectionNameField.text
    ...
    QQC2.Label {
        ...
        text: i18n("Manage named connections and default selection in System Settings > Desktop Assistant > Connections.")
    }
